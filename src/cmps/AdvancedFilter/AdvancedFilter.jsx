            ...
            <div className="modal-container-inner">
                            ...
                            <div className="advanced-filter-content">
                                ...
                                <div className="advanced-filter__top-tier">
                                    <div className="card-select card-select--selected">
                                        ...
                                        <span className="card-select__title">
                                            Guest favorites
                                        </span>
                                        ...
                                        <div className="checkbox-list-items">
                                            <label htmlFor="wifi" className='checkbox'>
                                                ...
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='wifi' className='checkbox-input' />
                                                    <span className="checkbox-custom"></span>
                                                </span>
                                            </label>
                                            <label htmlFor="kitchen" className='checkbox'>
                                                <span className='checkbox-label'>Kitchen</span>
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='kitchen' className='checkbox-input' />
                                                    <span className="checkbox-custom"></span>
                                                </span>
                                            </label>
                                            <label htmlFor="washer" className='checkbox'>
                                                <span className='checkbox-label'>Washer</span>
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='washer' className='checkbox-input' />
                                                    <span className="checkbox-custom"></span>
                                                </span>
                                            </label>
                                            <label htmlFor="dryer" className='checkbox'>
                                                <span className='checkbox-label'>Dryer</span>
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='dryer' className='checkbox-input' />
                                                    <span className="checkbox-custom"></span>
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                    <button className="checkbox-show-more">
                                        <span>Show more</span>
                                    </button>
                                </div>
                            </div>
                ...
                <footer>
                    <div className='advanced-filter-footer-content'>
                        <button className="advanced-filter-clear-button" type="button">Clear all</button>
