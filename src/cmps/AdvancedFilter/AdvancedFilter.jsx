...
export function AdvancedFilter({ handleCloseAdvancedFilter }) {
    ...
    const [selectedGuesthouseProperty, setSelectedGuesthouseProperty] = useState(null)
                ...
                <div className='filter-modal-content'>
                    <form className='advanced-filter-form' action="">
                        ...
                        <section>
                            <div className="advanced-filter-content">
                                <div className='advanced-filter-head'>
                                    <h2 className="advanced-filter-title advance-filter__no-subtitle">Rooms and beds</h2>
                        ...
                        <section>
                            <div className="advanced-filter-content">
                                <div className="advanced-filter-head">
                                    <h2 className="advanced-filter-title advance-filter__no-subtitle">Top-tier stays</h2>
                                </div>
                                <div className="advanced-filter__top-tier">
                                    <div className={`card-select ${selectedTopTier && 'card-select--selected'}`} onClick={() => setSelectedTopTier(!selectedTopTier)}>
                                        <span className="card-select__icon-wrapper">
                                            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{ height: '40px', width: '40px' }}>
                        ...
                        <section>
                            <div className="advanced-filter-content">
                                ...
                                <div className="advanced-filter__property-type">
                                    <div className={`card-select ${selectedHouseProperty && 'card-select--selected'}`} onClick={() => setSelectedHouseProperty(!selectedHouseProperty)}>
                                        <span className="card-select__icon-wrapper">
                                            <img src={homeLogo} style={{ width: '40px', height: '40px' }} alt="" />
                                        </span>
                                        <span className="card-select__title">House</span>
                                    </div>
                                    <div className={`card-select ${selectedGuesthouseProperty && 'card-select--selected'}`} onClick={() => setSelectedGuesthouseProperty(!selectedGuesthouseProperty)}>
                                        <span className="card-select__icon-wrapper">
                                            <img src={guesthouseLogo} style={{ width: '40px', height: '40px' }} alt="" />
                                        </span>
                                        <span className="card-select__title">Guesthouse</span>
                                    </div>
                                    <div className={`card-select ${selectedHotelProperty && 'card-select--selected'}`} onClick={() => setSelectedHotelProperty(!selectedHotelProperty)}>
                                        <span className="card-select__icon-wrapper">
                                            <img src={hotelLogo} style={{ width: '40px', height: '40px' }} alt="" />
                                        </span>
                        ...
                        <section>
                            <div className="advanced-filter-content">
                                <div className="advanced-filter-head">
                                    <h2 className="advanced-filter-title advance-filter__no-subtitle">Amenities</h2>
                                </div>
                                <div className="checkbox-list">
                                    <div>
                                        <h3 className="checkbox-list-title">Essentials</h3>
                                        <div className="checkbox-list-items">
                                            <label htmlFor="wifi" className='checkbox' onChange={handleCheckboxChange}>
                                                <span className='checkbox-label'>Wifi</span>
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='wifi' className='checkbox-input' checked={selectedAmenities.wifi} />
                                                    <span className={`checkbox-custom ${selectedAmenities.wifi ? 'checked' : ''}`}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', fill: 'none', height: '16px', width: '16px', stroke: 'currentcolor', strokeWidth: '4', overflow: 'visible', color: 'white' }}><path fill="none" d="m4 16.5 8 8 16-16"></path></svg></span>
                                                </span>
                                            </label>
                                            <label htmlFor="kitchen" className='checkbox' onChange={handleCheckboxChange}>
                                                <span className='checkbox-label'>Kitchen</span>
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='kitchen' className='checkbox-input' checked={selectedAmenities.kitchen} />
                                                    <span className={`checkbox-custom ${selectedAmenities.kitchen ? 'checked' : ''}`}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', fill: 'none', height: '16px', width: '16px', stroke: 'currentcolor', strokeWidth: '4', overflow: 'visible', color: 'white' }}><path fill="none" d="m4 16.5 8 8 16-16"></path></svg></span>
                                                </span>
                                            </label>
                                            <label htmlFor="washer" className='checkbox' onChange={handleCheckboxChange}>
                                                <span className='checkbox-label'>Washer</span>
                                                <span className="checkbox-container">
                                                    <input type="checkbox" id='washer' className='checkbox-input' checked={selectedAmenities.washer} />
                                                    <span className={`checkbox-custom ${selectedAmenities.washer ? 'checked' : ''}`}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', fill: 'none', height: '16px', width: '16px', stroke: 'currentcolor', strokeWidth: '4', overflow: 'visible', color: 'white' }}><path fill="none" d="m4 16.5 8 8 16-16"></path></svg></span>
                                                </span>
                                            </label>
                                            <label htmlFor="dryer" className='checkbox' onChange={handleCheckboxChange}>
                                                <span className='checkbox-label'>Dryer</span>
                                                <span className="checkbox-container">
